<?php 
	...
	$query_2 = "SELECT * FROM female WHERE Status = 'Available';";
		...
		<div id="page" class="container">
			<div class="title">
				...
				<form style="margin: auto;" method="POST" enctype="multipart/form-data">
					...
					<tr>
							<th>Name: </th>
							<td><input type="text" name="Name" value="" pattern="([a-zA-Z\s]){1,}" title="Must contain only letters" placeholder="Hermione Granger" required/></td>
						</tr>
						<tr>
							<th>Email: </th>
							<td><input type="email" name="Email" value="" placeholder="hermione@hogwarts.com"required/></td>
						</tr>
						<tr>
							<th>Address: </th>
							<td><input type="text" name="Address" value="" placeholder="Los Angeles" required/></td>
						</tr>
						<tr>
							<th>Contact no.: </th>
							<td><input type="number" name="Phn_no" pattern="[0-9]{10}" title="Must contain 10 digits" value="" placeholder="0123456789" required/></td>
						</tr>
						<tr>
							<th>Add room: </th>
							<td>
